...
T_Exp1Clrs = table( LLabel, CLabel, HueLabel, out32.x, out32.y, out32.Y, out32.L, out32.a, out32.b,...
    out32.Cab, out32.hab, 'VariableNames', { 'Lightness', 'Chroma','Hue', 'x', 'y', 'Y', 'L', 'a', 'b', 'C', 'h'});

writetable(T_Exp1Clrs, 'T_Exp1+2Clrs.csv')
...
writetable(T_Exp2Match, 'T_Exp2MatchColors.csv')


%% Plot colors for Experiment 1
