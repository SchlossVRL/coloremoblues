...
% Analyze and makes plots of data from Palmer et al. (2013)
BCPcoloremo 

% Define color coordinates for colors used in Exps. 1 and 2
DefineColors 

% Loads data in .mat file (Color-emotion assoications and Color apparance)
load EquilumData 
    %EmoLoad and EmoLoad2 store color-emotion associations from Exp 1 and 2, respectively. 
...
%Restructure the data in EquilumData so it is ready for plotting and R
%Also does some correlations
OrganizeData 

%Make color-emotion associations and color-appearance figures
MakeFigures
