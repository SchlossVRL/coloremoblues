...
%T_BCP.csv from berkeley color project (BCP), Palmer et al., (2013, PNAS)
...
T_EmoSubj = readtable('T_BCPEmoSubj.csv'); 

%separate HS data and A data for each subject (first col is subject #)
HSsubj = T_EmoSubj{:,2:38};
Asubj  = T_EmoSubj{:,39:75};
